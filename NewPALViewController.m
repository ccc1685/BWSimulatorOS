...
NSString * const palNPVCKey = @"palKey";

@implementation NewPALViewController
...
/*    NSUserDefaults *pickerViewSelectionDefaults = [NSUserDefaults standardUserDefaults];
    ...
    [acvitityPicker selectRow:[pickerViewSelectionDefaults integerForKey:@"newpicker0"]
                  inComponent:0 animated:YES];
    
    [acvitityPicker selectRow:[pickerViewSelectionDefaults integerForKey:@"newpicker1"]
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component
{
    ...
    NSString *key = [NSString stringWithFormat:@"newpicker%d", component];
    
    [[NSUserDefaults standardUserDefaults] setInteger:selectedRow forKey:key];


    NSLog(@"PAL = %g",pal);
    [[NSUserDefaults standardUserDefaults] setDouble:pal forKey:palNPVCKey];
    [person setPal:pal];
